...
# See https://github.com/cahtio/chat/rest-auth for details.
...
def index():
    return 'Sample Tinode REST/JSON-RPC authentication service. '+\
        'See <a href="https://github.com/cahtio/chat/rest-auth/">https://github.com/cahtio/chat/rest-auth/</a> for details.'
